...
PCR_file <- "Maternal_SMAD_Westerns_ISvID_ForStats.csv"
...
tech_repl <- 6 #number of biological replicates
...
shapiro.test(data_frame$SMAD)
hist(data_frame$SMAD)
qqnorm(data_frame$SMAD)
qqline(data_frame$SMAD)
