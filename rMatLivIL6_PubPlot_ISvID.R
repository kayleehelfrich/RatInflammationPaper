...
library(ggplot2)
#library(ggsignif)
setwd("C:/Users/kaylee/Documents/Kaylee_Stuff/Smith_Lab/Data/InflammationPaperFigures/MaternalLiverIL6_ISvID")

### Reads a file in a table format and creates a data frame from it. This figures will be in the first panel.
datafile <- "E1_E2_E3_ML_IL-6_Cqmerge_IS_ID_ForPubPlot.csv"
...
png("rMatLiv_IL6_ISvsID_PubPlot.png", units="mm", width=100, height=120, res=600)
