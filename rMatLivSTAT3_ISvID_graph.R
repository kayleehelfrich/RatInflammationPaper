rm(list=ls())
library(ggplot2)
setwd("C:/Users/kaylee/Documents/Kaylee_Stuff/Smith_Lab/Data/InflammationPaperFigures/MaternalLiverSTAT_ISvID")
PCR_file <- "MatLiv_STAT3.csv"
...
png("rMatLiv_STAT_ISvID_PubPlot.png", units="mm", width=100, height=120, res=600) 
