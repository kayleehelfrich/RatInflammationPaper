...
PCR_file <- "E1_E2_ML_BMP6_Cq_calculations_merge_for_ddCtPlot_ISIF.csv"
...
ID_0 <- data_frame[is.element(data_frame$Biological.Sets, "IF-M"),]
ID_5 <- data_frame[is.element(data_frame$Biological.Sets, "IF-PAE"),]
...
tech_repl <- 5 #number of biological replicates
