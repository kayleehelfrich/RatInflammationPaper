...
png("rFetLiv_IL1B_ISvsIF_ddCtDotPlot.png", units="mm", width=120, height=120, res=600)
...
p <- ggplot(data= dataframe_AdjCtCalcs, aes(x=Biological.Sets, y=Adj_Ct), fill=order) + #creates original graph
  ...
  ggtitle("IL1B Expression") + #adds title
  #xlab("Treatment") + #adds x-axis label
  ylab("Fetal Liver IL1B/Gapdh Relative to IS-MD") + #adds y-axis label
