rm(list=ls())
library(ggplot2)
setwd("C:/Users/kaylee/Documents/Kaylee_Stuff/Smith_Lab/Data/InflammationPaperFigures/FetalLiverSTAT_ISvID")
PCR_file <- "FetLiv_STAT3.csv"
...
png("rFetLiv_STAT_ISvID_PubPlot.png", units="mm", width=100, height=120, res=600) 
...
p<- ggplot(data_frame, aes(x=Treatments, y=mean, fill=sets)) + 
  ...
  labs(title=("Fetal STAT3 Activation"), y=("% Phosphorylation Relative to IS-M")) +
