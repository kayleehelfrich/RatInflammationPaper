...
datafile <- "FetLivIL10_Ctcalcs3_Combined_For_PubPlot.csv"
...
png("rFetLiv_IL10_ISvsIDvIF_PubPlot.png", units="mm", width=150, height=140, res=600)
...
plot <- ggplot(data= dataframe_AdjCtCalcs, aes(x=Biological.Sets, y=mean), fill=order) + #creates original graph
  ...
  ggtitle("Fetal Liver Il-10 Expression") +
  ...
  ylab(expression("Fetal Il-10/Gapdh Relative to IS-M")) + #adds y-axis label
