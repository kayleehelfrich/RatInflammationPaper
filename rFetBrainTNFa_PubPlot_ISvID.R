...
library(ggplot2)
#library(ggsignif)
setwd("C:/Users/kaylee/Documents/Kaylee_Stuff/Smith_Lab/Data/InflammationPaperFigures/FetalBrainTNFa_ISvID")

### Reads a file in a table format and creates a data frame from it. This figures will be in the first panel.
datafile <- "FetBrain_TNFa_CtCalcs_ISvID.csv"
...
png("rFetBrain_TNFa_ISvsID_PubPlot.png", units="mm", width=100, height=120, res=600)
