rm(list=ls())
library(ggplot2)
setwd("C:/Users/kaylee/Documents/Kaylee_Stuff/Smith_Lab/Data/InflammationPaperFigures/FetalLiverSMAD_ISvID")
PCR_file <- "FetLiv_SMAD.csv"
...
png("rFetLiv_SMAD_ISvID_PubPlot.png", units="mm", width=100, height=120, res=600) 
...
p<- ggplot(data_frame, aes(x=Treatments, y=mean, fill=sets)) + 
  ...
  labs(title=("Fetal SMAD1/5 Activation"), y=("% Phosphorylation Relative to IS-M")) +
